<div class="m-8 flex w-full content-center items-center fill-ordina">
	<div class="mx-auto">
		<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
			><rect class="spinner spinner_zWVm" x="1" y="1" width="7.33" height="7.33" /><rect
				class="spinner spinner_gfyD"
				x="8.33"
				y="1"
				width="7.33"
				height="7.33"
			/><rect class="spinner spinner_T5JJ" x="1" y="8.33" width="7.33" height="7.33" /><rect
				class="spinner spinner_E3Wz"
				x="15.66"
				y="1"
				width="7.33"
				height="7.33"
			/><rect class="spinner spinner_g2vs" x="8.33" y="8.33" width="7.33" height="7.33" /><rect
				class="spinner spinner_ctYB"
				x="1"
				y="15.66"
				width="7.33"
				height="7.33"
			/><rect class="spinner spinner_BDNj" x="15.66" y="8.33" width="7.33" height="7.33" /><rect
				class="spinner spinner_rCw3"
				x="8.33"
				y="15.66"
				width="7.33"
				height="7.33"
			/><rect class="spinner spinner_Rszm" x="15.66" y="15.66" width="7.33" height="7.33" /></svg
		>
	</div>
</div>
